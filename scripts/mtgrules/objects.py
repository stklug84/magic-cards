...
class Characteristics:
    ...
    # never carried them, consumers read them via getattr with a default).
...
class GameObject:
    ...
    def __init__(self, base: Characteristics, owner, *, is_token=False, card_ref=None):
...
class Player:
    ...
    def __init__(self, name: str, deck_name: str = ""):
        ...
        self.mana_pool: Any = None  # set by game (manasys.ManaPool)
        self.lost = False
        self.lose_reason = ""
